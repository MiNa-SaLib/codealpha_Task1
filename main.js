...
let zero = document.querySelector("form .zero");
...
let pname = document.querySelector("input[type='text']");
let pemail = document.querySelector("input[type='email']");
let invalidname = document.querySelector(".invalidName");
let invalidemail = document.querySelector(".invalidEmail");
console.log(pname);
start.addEventListener("click", function () {
    if (((/\w+@\w+\.\w+/i).test(pemail.value) && pemail.value.length > 0) && (pname.value.length > 0)) {
        //    pass
        ...
        if (!pname.value.length > 0) {
            invalidname.innerHTML = `Enter avalid name`;
            console.log("name false")
        } else {
            invalidname.innerHTML = ``;
        }
        if ((/\w+@\w+\.\w+/i).test(pemail.value) == false) {
            invalidemail.innerHTML = `Enter avalid email`;
...
form.onsubmit = function (e) {
    ...
    let all = "Answer of question 1: " + val1 + "<br/>" + "Answer of question 2: " + val2 + "<br/>" + "Answer of question 3: " + val3 + "<br/>" + "Answer of question 4: " + val4 + "<br/>" + "Answer of question 5: " + val5 + "<br/>" + "Answer of question 6: " + val6 + "<br/>" + "Answer of question 7: " + val7 + "<br/>" + "Answer of question 8: " + val8 + "<br/>" + "Answer of question 9: " + val9 + "<br/>" + "Answer of question 10: " + val10 + "<br/>";
